/* $Header: /home/jcb/MahJong/newmj/RCS/sysdep.h,v 12.2 2020/05/26 09:34:13 jcb Exp $
 * sysdep.h
...
/* similarly */
#define strmcat(dest,src,m) { strncat(dest,src, m - 1) ; dest[m-1] = '\000' ; }
